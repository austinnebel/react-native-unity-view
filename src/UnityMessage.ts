...
/** Prefix to add to every Unity message. */
export const UnityMessagePrefix = '@UnityMessage@';

/** Interface for unity messages. */
...
/** Implementation of Unity Message interfaces. */
export class UnityMessageImpl implements UnityMessage {
  ...
  public isRequestCompletion(): boolean {
    return (
      this.uuid !== undefined &&
      (this.type === UnityMessageType.Response ||
        this.type === UnityMessageType.Canceled ||
        this.type === UnityMessageType.Error)
    );
  }
